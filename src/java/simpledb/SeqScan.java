...
public class SeqScan implements DbIterator {
    ...
    public SeqScan(TransactionId tid, int tableid, String tableAlias) throws NoSuchElementException {
        // some code goes here
        this.tid = tid;
    ...
    public SeqScan(TransactionId tid, int tableid) throws NoSuchElementException {
